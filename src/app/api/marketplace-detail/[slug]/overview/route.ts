import { demoMarketplaceDetailOverview } from "@/shared/lib/demoSeed";
...
export async function GET(
  ...
  if (isDemoMode()) {
    const { slug: _demoSlug } = await params;
    return NextResponse.json(demoMarketplaceDetailOverview(_demoSlug));
  }
