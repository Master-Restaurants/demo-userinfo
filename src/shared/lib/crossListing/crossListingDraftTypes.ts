/**
 * Cross-Listing-Targets sind Plattformen, auf die wir publizieren können.
 * Sie sind NICHT identisch mit `AnalyticsMarketplaceSlug` — letzteres trennt
 * z. B. fressnapf DE/AT als Reporting-Kanäle, obwohl beide über DENSELBEN
 * Mirakl-Operator-API publiziert werden (eine Veröffentlichung erscheint
 * automatisch auf beiden Channels via Mirakl-Routing-Regeln).
 */
export type CrossListingTargetSlug =
  | "amazon"
  | "otto"
  | "ebay"
  | "kaufland"
