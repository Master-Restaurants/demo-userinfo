...
const nextConfig: NextConfig = {
  // Workspace-Root explizit setzen, damit Next.js die middleware.ts in diesem Projekt
  // findet (sonst fällt Next ggf. auf eine fremde package-lock.json im Home-Ordner zurück).
  turbopack: {
    root: __dirname,
  },
  async redirects() {
