...
export const PRICE_PARITY_DOC_BY_MARKETPLACE_SLUG: Record<AnalyticsMarketplaceSlug, PriceParityColumnApiDoc> = {
  ...
  // Fressnapf-AT teilt sich den Mirakl-Operator-API mit DE — gleiche
  // Produkte/Preise sind via channel_codes-Filter ziehbar; daher selber Doc.
  "fressnapf-at": PRICE_PARITY_DOC_FRESSNAPF,
